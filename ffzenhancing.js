...
(() => {
    ...
    function usernameElementClicked(el) {
        if (
            ...
            (el.classList.contains('tw-link') && el.parentNode.parentNode.parentNode.classList.contains('viewer-card-header__display-name')) // chatter name link in viewer card
        ) {
            return true;
        }
        return false;
